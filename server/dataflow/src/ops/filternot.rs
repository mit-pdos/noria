...
use super::filter::{FilterCondition, Value};
...
impl FilterNot {
    ...
    pub fn new(src: NodeIndex, filter: &[(usize, FilterCondition)]) -> FilterNot {
        FilterNot {
            src: src.into(),
