...
mod tests {
    /*
    use crate::controller::{WorkerHandle, Builder};
    use crate::controller::migrate::Migration;
    use noria::consensus::LocalAuthority;
    use petgraph::graph::NodeIndex;
    use std::{time, thread};

    fn build(sharding: Option<usize>, log: bool) -> WorkerHandle<LocalAuthority> {
    ...
    fn build_vote_controller(log: bool) -> WorkerHandle<LocalAuthority> {
