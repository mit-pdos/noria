        ...
        "read" => {
            let stats = match client {
                ...
                "mysql" => {
                    ...
                    exercise::launch_reader(clients::mysql::make_reader(&c, config.batch_size()), config)
                }
        ...
        "write" => {
            let stats = match client {
                ...
                "mysql" => {
                    ...
                    exercise::launch_writer(clients::mysql::make_writer(&c, config.batch_size()), config, None)
                }
                // hybrid://mysql=soup@127.0.0.1/bench_mysql,memcached=127.0.0.1:11211
                #[cfg(feature="b_hybrid")]
                "hybrid" => {
